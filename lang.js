...
(function() {
  var langs = {
    zh: {
      ...
      about_zodiac: '生肖', about_zodiac_val: '猪',
      about_orientation: '性取向', about_orientation_val: '异性恋（生理女）',
    ...
    en: {
      ...
      about_zodiac: 'Zodiac', about_zodiac_val: 'Pig',
      about_orientation: 'Orientation', about_orientation_val: 'Heterosexual (bio female)',
    ...
    ja: {
      ...
      about_zodiac: '干支', about_zodiac_val: '猪',
      about_orientation: '性的指向', about_orientation_val: '異性愛（生物学的女性）',
